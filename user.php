...
<div class="banner-bottom agile" id="auto">
		...
		<h2 class="tittle-one wow fadeInDown">user login			</h2>
		 <form name="form1" method="post" action="">
		   <table height="127" align="center">
             ...
             <tr>
               ...
               <td><div align="left"><span class="tp">
                 <input type="submit" name="btn" value="Login">
               </span></div></td>
             </tr>
             <tr>
               <td><div align="left"></div></td>
               <td><div align="left"><a href="user_register.php">New User Register Here... </a></div></td>
             </tr>
           </table>
		 </form>
