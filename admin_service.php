...
$charge=$_REQUEST['charge'];
 $sql = "SELECT id FROM service_details order by id ASC";
 ...
 $sid=0;
  ...
  while($row = $result->fetch_assoc()) 
  {
   ...
   $qrys1="insert into service_details values($sid,'$vehicle_name','$service_name','$charge','0','0')";
			...
			<div class="banner_top">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav cl-effect-14">
						...
						<li><a href="admin_service.php"  class="active">Service</a></li>
...
<div class="banner-bottom agile" id="auto">
		...
		<h2 class="tittle-one wow fadeInDown">add vehicle service </h2>
		 <form name="form1" method="post" action="">
		   <table height="127" align="center">
             <tr>
               <td><div align="left">Vehicle Name </div></td>
               <td> 
                 <input name="vehicle_name" type="text" id="vehicle_name" required="">                </td>
             </tr>
             <tr>
               <td><div align="left">Service Name </div></td>
               <td><input name="service_name" type="text" id="service_name" required=""></td>
             </tr>
             <tr>
               <td><div align="left">Charge</div></td>
               <td><input name="charge" type="number" id="charge" required=""></td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               <td><label>
