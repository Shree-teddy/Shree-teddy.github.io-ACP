   ...
   if(isset($Submit))
{
   ?>
           <table width="35%" height="83" border="0" align="center">
             ...
             <?php
	 	$qrys1="select * from  product_details where product_name LIKE '%$name%'";
	 ...
	 ?>
             <tr>
               ...
               <td><img src="upload/<?php echo $row['fname'];?>" width="75" height="75"></td>
               <td><?php echo $row['product_name'];?></td>
               <td><?php echo $row['brand'];?></td>
               <td><?php echo $row['amount'];?></td>
               <td><a href="user_machineries_1.php?id=<?php echo $row['id'];?>">Click...</a></td>
             </tr>
             <?php
	 }
	 ?>
