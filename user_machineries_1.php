...
extract($_POST);
 ...
 $email=$_SESSION['un']; 
 $id=$_REQUEST['id'];
  $qrys1="select * from  product_details where id='$id'";
...
window.location.href="user_machineries.php";
 </script>
<?php 
}
if(isset($Submit))
...
$sql = "SELECT id FROM user_machineries_booking order by id ASC";
 ...
 $sid=0;
  ...
  while($row = $result->fetch_assoc()) 
  {
   ...
   $qrys1="insert into user_machineries_booking values($sid,'$email','$product_name','$brand','$amount','$fname','$holder_name','$card_no','$cvv','$ex_date','0','0')";
...
<!-- //online-fonts -->
  ...
  ////////////////////////////////////
  let x1 = document.forms["form1"]["card_no"].value;
  if (x1 == "") 
  {
    alert("Enter Contact");
    return false;
			...
			<div class="banner_top">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav cl-effect-14">
						...
						<li><a href="user_service.php">Service</a></li>
						<li><a href="user_machineries.php"  class="active">Machineries</a></li>
...
<div class="banner-bottom agile" id="auto">
		...
		<h2 class="tittle-one wow fadeInDown">Machineries			</h2>
		 <form name="form1" method="post" action="" onSubmit="return validateForm()">
		   <table width="583" height="127" align="center">
             <tr>
               <td width="194" rowspan="6"><img src="upload/<?php echo $fname;?>" width="150" height="150"></td>
               <td width="178"><div align="left">Product Name </div></td>
               <td width="195"><div align="left"><?php echo $product_name;?>&nbsp;</div></td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td><div align="left"><?php echo $amount;?></div></td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td>
                   <div align="left">
                     <input name="card_no" type="number" id="card_no" required="">
                   </div></td>
             </tr>
             <tr>
