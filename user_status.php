			...
			<div class="banner_top">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav cl-effect-14">
						...
						<li><a href="user_status.php"  class="active">Status</a></li>
...
<div class="banner-bottom agile" id="auto">
		...
		<h2 class="tittle-one wow fadeInDown">machineries details </h2>
		 <form name="form1" method="post" action="">
		   <table width="80%" height="127" align="center">
             ...
             <?php
	 $qrys1="select * from  user_machineries_booking where email='$email'";
